 ...
 * complement notation. Therefore, in Example 3 above the input represents the signed integer -3.  
 * 
 * Follow up:
 * 
...
public class NumberOf1BitsSolution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new NumberOf1BitsSolution().hammingWeight(11));
        System.out.println(new NumberOf1BitsSolution().hammingWeight2(11));
    }
