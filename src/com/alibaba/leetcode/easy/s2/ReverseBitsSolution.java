...
public class ReverseBitsSolution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new ReverseBitsSolution().reverseBits(43261596));
        System.out.println(new ReverseBitsSolution().reverseBits(0xfffffffd));
    }

    /**
     * 依次取出每一位的二进制然后左移对应的位数，最后将各位二进制数求和
     * 
     * @param n
     * @return
     */
