 ...
 * Output: 7
 * 
 * Explanation: Buy on day 2 (price = 1) and sell on day 3 (price = 5), profit = 5-1 = 4.   Then buy on day 4 (price =
...
public class BestTimeToBuyAndSellStockIISolution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new BestTimeToBuyAndSellStockIISolution().maxProfit(new int[] {7, 1, 5, 3, 6, 4}));
        System.out.println(new BestTimeToBuyAndSellStockIISolution().maxProfit(new int[] {1, 2, 3, 4, 5}));
        System.out.println(new BestTimeToBuyAndSellStockIISolution().maxProfit(new int[] {7, 6, 4, 3, 1}));
    }
